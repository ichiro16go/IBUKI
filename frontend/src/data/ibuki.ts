...
export const hobbies: Hobby[] = [
  {
    ...
    beginnerNote: "写ルンですや中古コンパクトから。現像店を1つ見つけると続けやすい。",
    nearbyPlace: "渋谷フォトラボ · 徒歩8分",
    intro: "街の光や影を、あとでゆっくり受け取る趣味。散歩の速度が少しだけ変わります。",
  },
  {
    id: "togei",
    number: "012",
    ...
    intro: "形がゆっくり立ち上がる時間を楽しむ趣味。完成まで待つことも、体験の一部です。",
  },
  {
    id: "jazz-kissa",
    number: "022",
  ...
  },
  {
    ...
    beginnerNote: "双眼鏡がなくても、鳴き声アプリと公園のベンチから始められる。",
  ...
  },
  {
    ...
    beginnerNote: "まずは好きな一首を写すところから。SNS投稿でも十分に入口です。",
  ...
  },
  {
    ...
    intro: "会話と考える時間が自然に混ざる趣味。初対面でもルールが間をつないでくれます。",
  },
  {
    id: "sauna",
    number: "031",
    ...
    beginnerNote: "水分補給を忘れず、短いセットから。休憩を長めに取ると楽しい。",
  ...
  },
  {
    ...
    beginnerNote: "知らない駅で小さな本屋を1つ探す。買わなくても、棚を見るだけでいい。",
    nearbyPlace: "渋谷 Publishing & Books · 徒歩6分",
    intro: "本棚を通して街を見る趣味。旅ほど大きくなく、散歩より少し深い時間です。",
  },
];

export const encounters: Encounter[] = [
  { id: "enc-1", hobbyId: "film-camera", time: "3分前", distance: "110m", isNew: true, context: "dusk walk" },
  { id: "enc-2", hobbyId: "jazz-kissa", time: "26分前", distance: "510m", isNew: false, context: "after work" },
  { id: "enc-3", hobbyId: "board-game", time: "1時間前", distance: "850m", isNew: false, context: "station side" },
  { id: "enc-4", hobbyId: "birdwatching", time: "2時間前", distance: "4.2km", isNew: false, context: "morning park" },
];

export const encounterFilters = ["全て", "新しい", "近い順", "ひとり向け"];
export const savedFilters = ["全て", "今週", "いつかやってみたい", "近くで体験できる", "初心者向け"];

export const entrySteps: EntryStep[] = [
  { id: "find", title: "近くの教室を1つ見る", description: "料金と所要時間だけ確認する", status: "done" },
  { id: "book", title: "体験日を仮で決める", description: "週末の午前か平日の夜がおすすめ", status: "active" },
  { id: "go", title: "手ぶら体験に行く", description: "汚れてもいい服だけ選ぶ", status: "locked" },
  { id: "keep", title: "完成品を受け取る", description: "次に作りたい形をメモする", status: "locked" },
];
